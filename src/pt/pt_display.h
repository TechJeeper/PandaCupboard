 ...
 */
/** Restart RGB DMA at next VSYNC to clear a permanently shifted/wrapped image. */
void pt_display_resync();
/** DMA restart plus full LVGL invalidate (gear-menu Refresh Display). */
void pt_display_resync_and_redraw();
inline void pt_refresh_display() { pt_display_resync_and_redraw(); }
